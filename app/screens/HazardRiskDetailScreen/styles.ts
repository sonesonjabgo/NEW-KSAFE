...
export const $readOnlyBoxCompleted: ViewStyle = {
  borderRadius: 8,
  borderWidth: 1,
  borderColor: "#ECECEC",
...
export const $readOnlyBoxImpossible: ViewStyle = {
  borderRadius: 8,
  borderWidth: 1,
  borderColor: "#ECECEC",
...
export const $readOnlyText: TextStyle = {
  fontSize: 14,
  fontFamily: typography.primary.normal,
  color: "#555555",
  lineHeight: 22,
...
export const $lockRow: ViewStyle = {
  alignItems: "flex-end",
  marginTop: 8,
}
