...
const ar: Translations = {
  ...
  homeScreen: {
    ...
    edu: { title: "الانضمام إلى التعليم/العرض الحالي", description: "توجد غرفة تعليم/عرض تم إنشاؤها مسبقاً." },
    ...
    pushNotificationSheet: {
      ...
      description: "للحصول على تنبيهات السلامة والإشعارات في الوقت المناسب،\nيرجى السماح بإذن الإشعارات.",
  ...
  safeBoardCreateScreen: {
    ...
    pushNotification: {
      ...
      cardText:
        "عند التحديد، سيُرسل إشعار دفع إلى جميع أعضاء موقع العمل المحدد عند النشر.",
    },
    save: "حفظ",
  },
  ...
  safeHealthScreen: {
    ...
    menu: {
      ...
      tbmHistory: { title: "سجل المشاركة في TBM", description: "عرض سجل اجتماعات TBM المشارك فيها" },
  ...
  aiSafetyChatScreen: {
    ...
    welcomeMessage: "مرحباً! أنا مساعد السلامة الصناعية بالذكاء الاصطناعي.\nإذا كان لديك أي سؤال حول سلامة مواقع البناء فلا تتردد في السؤال.",
  ...
  tbmReportScreen: {
    ...
    sitePhotos: {
      ...
      guide:
        "يجب تسجيل صورة واحدة على الأقل من الموقع.\nيمكنك إرفاق من 1 إلى 5 صور.",
  ...
  welcomeIntroScreen: {
    ...
    slide3: {
      ...
      description:
        "فقط التقط صورة للموقع وسيحلل الذكاء الاصطناعي المخاطر\nويُنشئ لك مسودة تقرير.",
    },
  },
