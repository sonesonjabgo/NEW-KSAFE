...
const myOverrides = {
  ...
  aiSafetyChatScreen: {
    ...
    welcomeMessage:
      "မင်္ဂလာပါ! ကျွန်ုပ်သည် စမတ်ဘေးကင်းရေးစီမံခန့်ခွဲမှု AI ချတ်ဘော့ ဖြစ်သည်။\nအလုပ်ခွင်စည်းမျဉ်းများ၊ လုပ်ထုံးလုပ်နည်းများ သို့မဟုတ် အရေးပေါ်တုံ့ပြန်မှုလက်စွဲနှင့်ပတ်သက်၍ မေးမြန်းနိုင်ပါသည်။",
