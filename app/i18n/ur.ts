...
const urOverrides = {
  ...
  aiSafetyChatScreen: {
    ...
    welcomeMessage:
      "السلام علیکم! میں سمارٹ سیفٹی مینیجمنٹ AI چیٹ بوٹ ہوں۔\nاگر آپ کے کام کی جگہ کے قوانین، طریقہ کار یا ہنگامی ردعمل کے رہنما کتابچے کے بارے میں کوئی سوال ہو تو کسی بھی وقت پوچھیں۔",
